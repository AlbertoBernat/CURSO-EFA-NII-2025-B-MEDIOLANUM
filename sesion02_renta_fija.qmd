...
```{=html}
<object data="pdf\CLASE-DE-RENTA-FIJA-2025-MEDIOLANUM.pdf" type="application/pdf" width="100%" height="800px" style="min-height:100vh;">
  <p>Tu navegador no puede mostrar PDF embebidos. Puedes <a href="pdf\CLASE-DE-RENTA-FIJA-2025-MEDIOLANUM.pdf" target="_blank">descargarlo aquí</a>.</p>
</object>
```
...
:::{.text-center}
[Acceder al test](https://forms.gle/6yZYkkBuvpp4phE89){.btn .btn-success style="border-radius: 12px;" target="_blank"}
:::
:::
